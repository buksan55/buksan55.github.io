...
if 'Business Name' in df.columns and 'City' in df.columns:
    ...
    selected_cities = st.multiselect("Select Cities", business_city_counts['City'].unique(), default=business_city_counts['City'].unique()[:10])
    selected_businesses = st.multiselect("Select Business Names", business_city_counts['Business Name'].unique(), default=business_city_counts['Business Name'].unique()[:10])
