...
st.text("This graph is a bar chart showing the total number of licenses issued for each Lincese Type.")
st.text("The X-axis represnets differnet license types, while the Y-axis shows the total count of licenses issued for each type")
st.text("")
