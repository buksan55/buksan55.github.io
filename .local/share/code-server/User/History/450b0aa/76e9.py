...
st.text("The primary feature being emphasized is the significant variation in the number of licenses for certain types, such as Dental or Appraisal. ")
st.text("I chose a bar chart for its simplicity and clarity in showing categorical comparisons. I used a linear scale for the Y-axis categories to ensure the most common license types are easily identifiable.")
...
st.text("This visualization highlights the trend of licenses issued over time for specific License Types (e.g., Dental, Cosmo, Architect) across selected Cities. The key feature being explored is the temporal distribution of different license types within various cities, allowing us to identify spikes or trends in licensing activity.")
st.text(" For the design, I chose a line chart to clearly show changes over time, with different colors representing license types and varying line styles for cities to distinguish between them. ")
st.text(" A linear scale was used for the Y-axis to accurately reflect license counts, and interactive filters were implemented to allow users to dynamically select cities and license types of interest.")
