...
st.text("This graph is a bar chart showing the total number of licenses issued for each Lincese Type. The X-axis represnets differnet license types, while the Y-axis shows the total count of licenses issued for each type")
